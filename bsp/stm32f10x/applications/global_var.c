...
//		{				1,			&g_sys.config.general.cool_type,												 0,					  9,					COOL_TYPE_COLUMN_WIND,						3,					1,      NULL    },
...
//		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,				  	0xffff,			0x4ACC,				3,					1,      NULL   	},// DI极性,恒湿机
		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,				  	0xffff,			0x2C0,				3,					1,      NULL   	},// DI极性
//		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,				  	0xffff,			0xFFFC,				3,					1,      NULL   	},// DI极性
//		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,				  	0xffff,			0xAC0,				3,					1,      NULL   	},// DI极性,变频列间
		{				9,			&g_sys.config.dev_mask.din_bitmap_polarity[1],					 0,				  	0xffff,			0x00,				  3,					1,      NULL   	},
//		{				9,			&g_sys.config.dev_mask.din_bitmap_polarity[1],					 0,				  	0xffff,			0x03,				  3,					1,      NULL   	},
		{				10,			&g_sys.config.dev_mask.ain,													     0,				  	0xffff,			0x0000,				  3,					1,      NULL   	},
//		{				10,			&g_sys.config.dev_mask.ain,													     0,				  	0xffff,			0x0408,				3,					1,      NULL   	},
...
//		{				14,			&g_sys.config.dev_mask.mb_comp,													 0,				  	0xFFFF,			0x0A01,			  3,					1,      NULL   	},
//		{				14,			&g_sys.config.dev_mask.mb_comp,													 0,				  	0xFFFF,			0x0201,			  3,					1,      NULL   	},//通信位
		{				14,			&g_sys.config.dev_mask.mb_comp,													 0,				  	0xFFFF,			0x1200,			  3,					1,      NULL   	},//通信位
		{				15,			&g_sys.config.dev_mask.dout,														 0,				  	0xffff,			0xB04F,				3,					1,      NULL   	},
//		{				15,			&g_sys.config.dev_mask.dout,														 0,				  	0xffff,			0x1F7,				3,				1,      NULL   	},//数字输出
...
//		{				29,			&g_sys.config.algorithm.temp_precision,									 1,			  	  100,				20,					  1,					1,      NULL   	},
		{				30,			&g_sys.config.algorithm.hum_precision,									 1,			  	  150,				50,					  1,					1,      NULL   	},
		{				31,			&g_sys.config.algorithm.temp_deadband,									 0,				  	50,					10,						1,					1,      NULL   	},
//		{				31,			&g_sys.config.algorithm.temp_deadband,									 0,				  	50,					5,						1,					1,      NULL   	},
...
//		{				38,			&g_sys.config.dev_mask.pwm_out,													 0,				  	0x0003,			0,						0,					1,      NULL   	},
...
//		{				65,			&g_sys.config.compressor.type,										 	     0,				  	1,					0,						2,					1,      NULL   	},
...
//		{				107,		&g_sys.config.humidifier.flush_time,							       1,				  	120,				3,						2,					1,      NULL   	},
		{				107,		&g_sys.config.humidifier.flush_time,							       1,				  	120,				30,						2,					1,      NULL   	},
//		{				108,		&g_sys.config.humidifier.flush_interval,						     1,					  120,				3,					  2,					1,      NULL   	},
...
//		{				113,		&g_sys.config.humidifier.hum_time,									     1,				    600,			  240,					  2,					1,      NULL   	},
...
//		{				126,		&g_sys.config.hgbp.on_req,															 10,				  50,					30,						0,					1,      NULL   	},
//		{				127,		&g_sys.config.hgbp.hysterisis,													 10,				  25,					15,						0,					1,      NULL   	},
//		{				128,		&g_sys.config.hgbp.max_on_time,													 5,				  	300,				15,						0,					1,      NULL   	},
//		{				129,		&g_sys.config.hgbp.min_off_time,												 30,				  900,				300,					0,					1,      NULL    },
...
//		{				167,		&g_sys.config.dev_mask.din_pusl,												 0,				  	0xffff,			0x0000,				3,					1,      NULL   	},		
...
//		{				174,		(uint16_t *)&l_sys.pwm_list[PWM_OUT0][BITMAP_MANUAL],		 0,			  		100,				0,						0,					1,      NULL   	},
//		{				175,		(uint16_t *)&l_sys.pwm_list[PWM_OUT1][BITMAP_MANUAL],		 0,			  		100,				0,						0,					1,      NULL   	},
...
//		{				203,		&g_sys.config.alarm[ACL_HI_TMP1].enable_mode,						 0,					  7,					5,						2,					1,      NULL   	},
//		{				204,		&g_sys.config.alarm[ACL_HI_TMP1].delay,									 5,					  100,				10,						2,					1,      NULL   	},
//		{				205,		&g_sys.config.alarm[ACL_HI_TMP1].alarm_param,					   100,					350,			  350,					2,					1,      NULL 	  },
		{			  203,    NULL,			 	                                             0,				    3600,			  0,						2,					1,      NULL   	},
		{			  204,    NULL,			 	                                             0,				    3600,			  0,						2,					1,      NULL   	},
		{			  205,    NULL,			 	                                             0,				    3600,			  0,						2,					1,      NULL   	},
//		{				206,		&g_sys.config.alarm[ACL_HI_TMP2].enable_mode,					   0,					  7,					4,						2,					1,      NULL    },
//		{				207,		&g_sys.config.alarm[ACL_HI_TMP2].delay,								   5,					  100,				10,						2,					1,      NULL    },
//		{				208,		&g_sys.config.alarm[ACL_HI_TMP2].alarm_param,					   0,					  0,			    0,					  2,				  1,      NULL    },
...
//		{			  326,    &g_sys.config.alarm[ACL_WATERPAN].enable_mode,		 				0,					  7,					0,						2,					1,      NULL   	},
//		{			  327,    &g_sys.config.alarm[ACL_WATERPAN].delay,					 				1,					100,					5,						2,					1,      NULL   	},
//		{			  328,    &g_sys.config.alarm[ACL_WATERPAN].alarm_param,		 				0,					  1,		    	0,						2,					1,      NULL   	},
...
//		{			  451,		&g_sys.config.ext_tmp.mioor_alarm_tmp,							 	  500,					1500,		 1100,						2,					1,      NULL},
//		{			  452,		&g_sys.config.ext_tmp.critical_alarm_tmp,					 		  500,					1500,		 1200,						2,					1,      NULL},
...
//		{			  478,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  479,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
//		{			  480,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},				
//		{			  481,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  482,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
//		{			  483,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},
//		{			  484,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  485,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
//		{			  486,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},				
//		{			  487,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  488,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
//		{			  489,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},
//		{			  490,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},				
//		{			  491,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  492,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
//		{			  493,    NULL,						 	                                       0,					  0,				  0,						2,					1,      NULL   	},
//		{			  494,    NULL,			 	                                             0,					  0,			    0,					  2,					1,      NULL   	},
//		{			  495,    NULL,			 	                                             0,				    0,			  	0,						2,					1,      NULL   	},
}; 
...
{		// 			id			mapped registers														default				
    ...
    {				75,		 	&g_sys.status.mbm.pwr[0].p_cur[2],						  0},
		{				76,			&g_sys.status.mbm.pwr[1].pa_volt,							0},
		{				77,			&g_sys.status.mbm.pwr[1].pb_volt,							0},
		{				78,			&g_sys.status.mbm.pwr[1].pc_volt,							0},
		{				79,			&g_sys.status.mbm.pwr[1].freq,									0},
		{				80,			&g_sys.status.mbm.pwr[1].dev_sts,						  0},
    {				81,		  &g_sys.status.mbm.pwr[1].p_cur[0],						  0},
    {				82,		  &g_sys.status.mbm.pwr[1].p_cur[1],						  0},
    {				83,		 	&g_sys.status.mbm.pwr[1].p_cur[2],						  0},
