...
const conf_reg_map_st conf_reg_map_inst[CONF_REG_MAP_NUM] = {
    ...
    //		{				1,			&g_sys.config.general.cool_type, 0,
    // 9,
    ...
    //		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,
    // 0xffff,
    // 0x4ACC,
    // 3,					1,      NULL   	},// DI极性,恒湿机
    {8, &g_sys.config.dev_mask.din_bitmap_polarity[0], 0, 0xffff, 0x0000, 3, 1, NULL},  // DI极性
    //		{				8,      &g_sys.config.dev_mask.din_bitmap_polarity[0],					 0,
    // 0xffff,
    // 0xFFFC,
    // 3,					1,      NULL   	},// DI极性
    ...
    //		{				9,			&g_sys.config.dev_mask.din_bitmap_polarity[1],					 0,
    // 0xffff,
    // 0x03,
    // 3,					1,      NULL   	},
    {10, &g_sys.config.dev_mask.ain, 0, 0xffff, 0x0000, 3, 1, NULL},
    //		{				10,			&g_sys.config.dev_mask.ain, 0,
    // 0xffff,
    // 0x0408,
    // 3,					1,      NULL   	},
    ...
    //		{				14,			&g_sys.config.dev_mask.mb_comp, 0,
    // 0xFFFF,
    // 0x0A01,
    // 3,					1,      NULL   	},
    //		{				14,			&g_sys.config.dev_mask.mb_comp, 0,
    ...
    //		{				15,			&g_sys.config.dev_mask.dout, 0,
    // 0xffff,
    // 0x1F7,
    // 3,				1,      NULL   	},//数字输出
    ...
    //		{				38,			&g_sys.config.dev_mask.pwm_out, 0,
    // 0x0003,
    // 0,
    // 0,					1,      NULL   	},
    ...
    //		{				65,			&g_sys.config.compressor.type,										 	     0,
    // 1,
    // 0,
    // 2,					1,      NULL   	},
    ...
    //		{				107,		&g_sys.config.humidifier.flush_time,							       1,
    // 120,
    // 3,
    // 2,					1,      NULL   	},
    {107, &g_sys.config.humidifier.flush_time, 1, 120, 30, 2, 1, NULL},
    //		{				108,		&g_sys.config.humidifier.flush_interval,						     1,
    // 120,
    // 3,
    // 2,					1,      NULL   	},
    ...
    //		{				113,		&g_sys.config.humidifier.hum_time,									     1,
    // 600,
    // 240,
    // 2,					1,      NULL   	},
    ...
    //		{				126,		&g_sys.config.hgbp.on_req, 10,
    // 50,
    // 30,
    // 0,					1,      NULL   	},
    //		{				127,		&g_sys.config.hgbp.hysterisis, 10,
    // 25,
    // 15,
    // 0,					1,      NULL   	},
    //		{				128,		&g_sys.config.hgbp.max_on_time, 5,
    // 300,
    // 15,
    // 0,					1,      NULL   	},
    //		{				129,		&g_sys.config.hgbp.min_off_time, 30,
    // 900,
    // 300,
    // 0,					1,      NULL    },
    ...
    //		{				167,		&g_sys.config.dev_mask.din_pusl, 0,
    // 0xffff,
    // 0x0000,
    // 3,					1,      NULL   	},
    ...
    //		{				174,		(uint16_t *)&l_sys.pwm_list[PWM_OUT0][BITMAP_MANUAL],		 0, 100,
    // 0,
    // 0,					1,      NULL   	},
    //		{				175,		(uint16_t *)&l_sys.pwm_list[PWM_OUT1][BITMAP_MANUAL],		 0, 100,
    // 0,
    // 0,					1,      NULL   	},
    ...
    //		{				203,		&g_sys.config.alarm[ACL_HI_TMP1].enable_mode,						 0,
    // 7,
    // 5,
    // 2,					1,      NULL   	},
    //		{				204,		&g_sys.config.alarm[ACL_HI_TMP1].delay,									 5,
    // 100,
    // 10,
    // 2,					1,      NULL   	},
    //		{				205,		&g_sys.config.alarm[ACL_HI_TMP1].alarm_param,					   100,
    // 350,
    // 350,
    // 2,					1,      NULL 	  },
    ...
    //		{				206,		&g_sys.config.alarm[ACL_HI_TMP2].enable_mode,					   0,
    // 7,
    // 4,
    // 2,					1,      NULL    },
    //		{				207,		&g_sys.config.alarm[ACL_HI_TMP2].delay,								   5,
    // 100,
    // 10,
    // 2,					1,      NULL    },
    //		{				208,		&g_sys.config.alarm[ACL_HI_TMP2].alarm_param,					   0,
    // 0,
    // 0,
    // 2,				  1,      NULL    },
...
const sts_reg_map_st status_reg_map_inst[STATUS_REG_MAP_NUM] = {
    ...
    {87, &g_sys.status.ICT.PG1_PG2, 0},
    {88, &g_sys.status.ICT.PUMP, 0},
    {89, &g_sys.status.ICT.P2, 0},
    {90, &g_sys.status.ICT.P3, 0},
...
uint16_t sys_local_var_init(void)
{
    ...
    g_sys.config.dev_mask.mb_comp                = 0;
...
uint16 reg_map_write(uint16 reg_addr, uint16 *wr_data, uint8_t wr_cnt, uint8_t User_ID)
{
    ...
    for (i = 0; i < wr_cnt; i++)  // data write
    {
        ...
        *(conf_reg_map_inst[reg_addr + i].reg_ptr) = *(wr_data + i);  // write data to designated register
        ...
        // eeprom
        //
        //				I2C_EE_BufRead((uint8_t *)&ee_rd_cheksum,CONF_REG_EE1_ADDR+(CONF_REG_MAP_NUM*2),2);	//read
        // legacy checksum data 				ee_rd_cheksum = ee_rd_cheksum^ee_rd_data^ee_wr_data;
